...
public class QuantumInjectionMoldingMachineScreen extends AbstractContainerScreen<QuantumInjectionMoldingMachineMenu> {
    ...
    public QuantumInjectionMoldingMachineScreen(QuantumInjectionMoldingMachineMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignFluidRenderer() {
        renderer = new FluidTankRenderer(QuantumInjectionMoldingMachineBlockEntity.FLUID_CAPACITY, true, FLUID_BAR_WIDTH, FLUID_BAR_HEIGHT);
    }
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        QuantumInjectionMoldingMachineBlockEntity blockEntity = menu.getBlockEntity();
        ...
        if (mouseX >= leftPos + ENERGY_BAR_X && mouseX < leftPos + ENERGY_BAR_X + ENERGY_BAR_WIDTH &&
            ...
            double powerCapacitykFE = (double) QuantumInjectionMoldingMachineBlockEntity.ENERGY_CAPACITY / 1000;
        ...
        if (mouseX >= leftPos + FLUID_BAR_X && mouseX < leftPos + FLUID_BAR_X + FLUID_BAR_WIDTH &&
            ...
            double fluidCapacitykFE = (double) QuantumInjectionMoldingMachineBlockEntity.FLUID_CAPACITY / 1000;
