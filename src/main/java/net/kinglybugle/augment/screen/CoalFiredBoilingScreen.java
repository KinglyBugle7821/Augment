...
public class CoalFiredBoilingScreen extends AbstractContainerScreen<CoalFiredBoilingMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Augment.MOD_ID, "textures/gui/container/coal_fired_boiler_gui.png");
    private EnergyInfoArea energyInfoArea;

    public CoalFiredBoilingScreen(CoalFiredBoilingMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        CoalFiredBoilerBlockEntity blockEntity = menu.getBlockEntity();
        ...
        if (mouseX >= leftPos + ENERGY_LEFT && mouseX < leftPos + ENERGY_LEFT + 16 &&
            ...
            guiGraphics.renderTooltip(this.font, Component.literal(power + " FE / " + CoalFiredBoilerBlockEntity.CAPACITY + " FE" ), mouseX, mouseY);
        }
    }
}
