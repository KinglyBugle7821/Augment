...
public class SimpleInjectionMoldingMachineScreen extends AbstractContainerScreen<SimpleInjectionMoldingMachineMenu> {
    ...
    public SimpleInjectionMoldingMachineScreen(SimpleInjectionMoldingMachineMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignFluidRenderer() {
        renderer = new FluidTankRenderer(SimpleInjectionMoldingMachineBlockEntity.FLUID_CAPACITY, true, FLUID_BAR_WIDTH, FLUID_BAR_HEIGHT);
    }
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        SimpleInjectionMoldingMachineBlockEntity blockEntity = menu.getBlockEntity();
        ...
        if (mouseX >= leftPos + ENERGY_BAR_X && mouseX < leftPos + ENERGY_BAR_X + ENERGY_BAR_WIDTH &&
            ...
            double powerCapacitykFE = (double) SimpleInjectionMoldingMachineBlockEntity.ENERGY_CAPACITY / 1000;
        ...
        if (mouseX >= leftPos + FLUID_BAR_X && mouseX < leftPos + FLUID_BAR_X + FLUID_BAR_WIDTH &&
            ...
            double fluidCapacitykFE = (double) SimpleInjectionMoldingMachineBlockEntity.FLUID_CAPACITY / 1000;
