...
public class AdvancedCoalFiredBoilingScreen extends AbstractContainerScreen<AdvancedCoalFiredBoilingMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Augment.MOD_ID, "textures/gui/container/coal_fired_boiler_gui.png");
    private EnergyInfoArea energyInfoArea;

    public AdvancedCoalFiredBoilingScreen(AdvancedCoalFiredBoilingMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        AdvancedCoalFiredBoilerBlockEntity blockEntity = menu.getBlockEntity();
        ...
        if (mouseX >= leftPos + ENERGY_LEFT && mouseX < leftPos + ENERGY_LEFT + 16 &&
            ...
            double powerCapacitykFE = (double) AdvancedCoalFiredBoilerBlockEntity.CAPACITY / 1000;
