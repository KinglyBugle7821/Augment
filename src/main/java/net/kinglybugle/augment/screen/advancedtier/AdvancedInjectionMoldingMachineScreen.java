...
public class AdvancedInjectionMoldingMachineScreen extends AbstractContainerScreen<AdvancedInjectionMoldingMachineMenu> {
    ...
    public AdvancedInjectionMoldingMachineScreen(AdvancedInjectionMoldingMachineMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignFluidRenderer() {
        renderer = new FluidTankRenderer(AdvancedInjectionMoldingMachineBlockEntity.FLUID_CAPACITY, true, FLUID_BAR_WIDTH, FLUID_BAR_HEIGHT);
    }
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        AdvancedInjectionMoldingMachineBlockEntity blockEntity = menu.getBlockEntity();
        ...
        if (mouseX >= leftPos + ENERGY_BAR_X && mouseX < leftPos + ENERGY_BAR_X + ENERGY_BAR_WIDTH &&
            ...
            double powerCapacitykFE = (double) AdvancedInjectionMoldingMachineBlockEntity.ENERGY_CAPACITY / 1000;
        ...
        if (mouseX >= leftPos + FLUID_BAR_X && mouseX < leftPos + FLUID_BAR_X + FLUID_BAR_WIDTH &&
            ...
            double fluidCapacitykFE = (double) AdvancedInjectionMoldingMachineBlockEntity.FLUID_CAPACITY / 1000;
