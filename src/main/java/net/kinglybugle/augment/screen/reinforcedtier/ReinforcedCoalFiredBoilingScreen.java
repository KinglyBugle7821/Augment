...
public class ReinforcedCoalFiredBoilingScreen extends AbstractContainerScreen<ReinforcedCoalFiredBoilingMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Augment.MOD_ID, "textures/gui/container/coal_fired_boiler_gui.png");
    private EnergyInfoArea energyInfoArea;

    public ReinforcedCoalFiredBoilingScreen(ReinforcedCoalFiredBoilingMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        ReinforcedCoalFiredBoilerBlockEntity blockEntity = menu.getBlockEntity();
        ...
        if (mouseX >= leftPos + ENERGY_LEFT && mouseX < leftPos + ENERGY_LEFT + 16 &&
            ...
            double powerCapacitykFE = (double) ReinforcedCoalFiredBoilerBlockEntity.CAPACITY / 1000;
