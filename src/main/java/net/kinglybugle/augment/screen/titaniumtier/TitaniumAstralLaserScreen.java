...
public class TitaniumAstralLaserScreen extends AbstractContainerScreen<TitaniumAstralLaserMenu> {
    private static final int ENERGY_LEFT = 152;
    private static final int ENERGY_TOP = 8;
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Augment.MOD_ID, "textures/gui/container/astral_laser_gui.png");
    private EnergyInfoArea energyInfoArea;

    public TitaniumAstralLaserScreen(TitaniumAstralLaserMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignEnergyInfoArea() {
        ...
        energyInfoArea = new EnergyInfoArea(x + ENERGY_LEFT, y + ENERGY_TOP, menu.blockEntity.getEnergyStorage());
    }
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        TitaniumAstralLaserBlockEntity blockEntity = menu.getBlockEntity();
        ...
        if (mouseX >= leftPos + ENERGY_LEFT && mouseX < leftPos + ENERGY_LEFT + 16 &&
            ...
            double powerCapacitykFE = (double) TitaniumAstralLaserBlockEntity.CAPACITY / 1000;
